...
- `static inline const char * `[`get_generic_disk_str`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L21)`(`[`enum generic_disk_type`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L14)` type)`
- `static inline const char * `[`get_generic_disk_dev_str`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L31)`(`[`enum generic_disk_type`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L14)` t)`
- `static inline bool `[`disk_skip_coalesce`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L103)`(`[`struct generic_disk`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L68)` *disk)`
- `static inline bool `[`disk_skip_sched`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L107)`(`[`struct generic_disk`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L68)` *disk)`
- `static inline bool `[`disk_skip_reorder`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L111)`(`[`struct generic_disk`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L68)` *disk)`

...
- `void * `[`bcache_get`](https://github.com/bluegummi/charmos/blob/main/include/block/bcache.h#L67)`(`[`struct generic_disk`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L68)` *disk`,`uint64_t lba`,`uint64_t block_size`,`uint64_t spb`,`bool no_evict`,[`struct bcache_entry`](https://github.com/bluegummi/charmos/blob/main/include/block/bcache.h#L18)` **out_entry)`
- `void * `[`bcache_create_ent`](https://github.com/bluegummi/charmos/blob/main/include/block/bcache.h#L87)`(`[`struct generic_disk`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L68)` *disk`,`uint64_t lba`,`uint64_t block_size`,`uint64_t sectors_per_block`,`bool no_evict`,[`struct bcache_entry`](https://github.com/bluegummi/charmos/blob/main/include/block/bcache.h#L18)` **out_entry)`

...
- [`slab_check_meta()`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/check.c#L37) — `bool slab_check_meta(`[`struct slab`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)` *slab)`
- [`slab_check()`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/check.c#L43) — `bool slab_check(`[`struct slab`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)` *slab)`

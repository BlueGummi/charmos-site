...
- `static inline bool `[`slab_magazine_full`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L189)`(`[`struct slab_magazine`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L182)` *mag)`
- `static inline`[`struct domain_buddy *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L80)[`slab_domain_buddy`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L456)`(`[`struct slab_domain`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L423)` *domain)`
- `static inline void `[`slab_gc_update_ewma`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L538)`(`[`struct slab_cache`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L254)` *cache)`
- `static inline`[`struct slab_page_hdr *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L461)[`slab_page_hdr_for_addr`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L557)`(void *ptr)`
- `static inline size_t `[`slab_object_count`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L561)`(`[`struct slab`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)` *slab)`
- `static inline size_t `[`slab_object_size`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L565)`(`[`struct slab`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)` *slab)`
- `static inline`[`struct slab *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)[`slab_for_ptr`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L573)`(void *ptr)`
- `static inline`[`struct slab_domain *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L423)[`slab_domain_local`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L577)`(void)`
- `static inline`[`struct slab_percpu_cache *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L193)[`slab_percpu_cache_local`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L581)`(void)`
- `static inline void `[`slab_list_del`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L585)`(`[`struct slab`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)` *slab)`
- `static inline void `[`slab_list_add`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L601)`(`[`struct slab_cache`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L254)` *cache`,[`struct slab`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)` *slab)`
- `static inline void `[`slab_move`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L612)`(`[`struct slab_cache`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L254)` *c`,[`struct slab`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)` *slab`,[`enum slab_state`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L127)` new)`
- `static inline void `[`slab_byte_idx_and_mask_from_idx`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L622)`(uint64_t index`,`uint64_t *byte_idx_out`,`uint8_t *bitmask_out)`
- `static inline void `[`slab_index_and_mask_from_ptr`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L629)`(`[`struct slab`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L140)` *slab`,`void *obj`,`uint64_t *byte_idx_out`,`uint8_t *bitmask_out)`
- `static inline`[`struct slab_cache *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L254)[`slab_caches_alloc`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/slab/internal.h#L641)`()`

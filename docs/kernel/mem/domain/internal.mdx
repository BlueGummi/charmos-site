...
- `static inline`[`struct domain_buddy *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L80)[`domain_buddy_for_addr`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L131)`(`[`paddr_t`](https://github.com/bluegummi/charmos/blob/main/include/types/types.h#L12)` addr)`
- `static inline`[`struct domain_buddy *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L80)[`domain_buddy_on_this_core`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L143)`(void)`
- `static inline`[`struct domain_arena *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L22)[`domain_arena_on_this_core`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L147)`(void)`
- `static inline`[`struct domain_free_queue *`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L31)[`domain_free_queue_on_this_core`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L151)`(void)`
- `static inline size_t * `[`domain_rr_on_this_core`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L155)`(void)`
- `static inline void `[`domain_stat_alloc`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L159)`(`[`struct domain_buddy`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L80)` *d`,`bool remote`,`bool interleaved)`
- `static inline void `[`domain_stat_free`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L172)`(`[`struct domain_buddy`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L80)` *d)`
- `static inline void `[`domain_stat_mark_interleaved`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L176)`(`[`struct domain_buddy`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L80)` *d)`
- `static inline void `[`domain_stat_failed_alloc`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L182)`(`[`struct domain_buddy`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L80)` *d)`
- `static inline bool `[`is_free_in_progress`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L188)`(`[`struct domain_free_queue`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L31)` *fq)`
- `static inline void `[`mark_free_in_progress`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L192)`(`[`struct domain_free_queue`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L31)` *fq`,`bool s)`
- `static inline`[`struct page *`](https://github.com/bluegummi/charmos/blob/main/include/mem/page.h#L38)[`buddy_page_for_addr`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L196)`(`[`paddr_t`](https://github.com/bluegummi/charmos/blob/main/include/types/types.h#L12)` address)`
- `static inline void `[`free_from_buddy_internal`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L200)`(`[`struct domain_buddy`](https://github.com/bluegummi/charmos/blob/main/kernel/mem/domain/internal.h#L80)` *target`,[`paddr_t`](https://github.com/bluegummi/charmos/blob/main/include/types/types.h#L12)` address`,`size_t page_count)`

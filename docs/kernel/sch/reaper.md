...
- [`reaper_get_reaped_thread_count()`](https://github.com/bluegummi/charmos/blob/main/kernel/sch/reaper.c#L19) — `uint64_t reaper_get_reaped_thread_count(void)`
- [`reaper_thread_main()`](https://github.com/bluegummi/charmos/blob/main/kernel/sch/reaper.c#L23) — `void reaper_thread_main(void)`

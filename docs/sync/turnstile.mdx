...
- [`struct turnstile *`](https://github.com/bluegummi/charmos/blob/main/include/sync/turnstile.h#L21)[`turnstile_block`](https://github.com/bluegummi/charmos/blob/main/include/sync/turnstile.h#L61)`(`[`struct turnstile`](https://github.com/bluegummi/charmos/blob/main/include/sync/turnstile.h#L21)` *ts`,`size_t queue_num`,`void *lock_obj`,[`enum irql`](https://github.com/bluegummi/charmos/blob/main/include/sch/irql.h#L2)` lock_irql)`
- [`struct turnstile *`](https://github.com/bluegummi/charmos/blob/main/include/sync/turnstile.h#L21)[`turnstile_lookup`](https://github.com/bluegummi/charmos/blob/main/include/sync/turnstile.h#L63)`(void *obj`,[`enum irql`](https://github.com/bluegummi/charmos/blob/main/include/sch/irql.h#L2)` *irql_out)`

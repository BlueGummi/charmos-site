...
- `static inline const char * `[`irql_to_str`](https://github.com/bluegummi/charmos/blob/main/include/sch/irql.h#L11)`(`[`enum irql`](https://github.com/bluegummi/charmos/blob/main/include/sch/irql.h#L2)` level)`

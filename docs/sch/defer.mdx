...
- [`struct workqueue *`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L194)[`workqueue_create`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L259)`(`[`struct workqueue_attributes`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L174)` *attrs`,`char *fmt)`
- [`struct work *`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L32)[`work_create`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L261)`(work_function func`,[`struct work_args`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L17)` args)`
- [`struct work *`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L32)[`work_init`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L262)`(`[`struct work`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L32)` *work`,`work_function fn`,[`struct work_args`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L17)` args)`
- [`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`worker_create`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L290)`(void)`
- [`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`worker_create_unmigratable`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L291)`()`
- [`struct worklist *`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L85)[`worklist_create`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L292)`(`[`enum worklist_flags`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L81)`)`
- `static inline bool `[`work_active`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L300)`(`[`struct work`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L32)` *work)`

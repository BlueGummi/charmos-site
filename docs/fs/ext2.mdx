...
- `uint8_t * `[`ext2_block_read`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L249)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs`,`uint32_t block_num`,[`struct bcache_entry`](https://github.com/bluegummi/charmos/blob/main/include/block/bcache.h#L18)` **out)`
- [`struct vfs_node *`](https://github.com/bluegummi/charmos/blob/main/include/fs/vfs.h#L198)[`ext2_g_mount`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L264)`(`[`struct generic_partition`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L41)` *)`
- [`struct ext2_inode *`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L178)[`ext2_inode_read`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L266)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs`,`uint32_t inode_idx`,[`struct bcache_entry`](https://github.com/bluegummi/charmos/blob/main/include/block/bcache.h#L18)` **out_ent)`
- `static inline void `[`ext2_dealloc_inode`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L294)`(`[`struct ext2_full_inode`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L201)` *ino)`
- `static inline uint32_t `[`ext2_get_block_group`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L298)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs`,`uint32_t block)`
- `static inline uint32_t `[`ext2_get_inode_group`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L303)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs`,`uint32_t inode)`
- `static inline bool `[`ext2_fs_lock`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L308)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs)`
- `static inline void `[`ext2_fs_unlock`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L312)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs`,`bool b)`
- `static inline void `[`ext2_prefetch_block`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L316)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs`,`uint32_t block)`
- `static inline void `[`ext2_inode_lock`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L322)`(`[`struct ext2_full_inode`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L201)` *ino)`
- `static inline void `[`ext2_inode_unlock`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L326)`(`[`struct ext2_full_inode`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L201)` *ino)`
- `static inline uint8_t * `[`ext2_create_bcache_ent`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L330)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs`,`uint32_t block`,[`struct bcache_entry`](https://github.com/bluegummi/charmos/blob/main/include/block/bcache.h#L18)` **out)`
- [`struct ext2_full_inode *`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L201)[`ext2_find_file_in_dir`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L378)`(`[`struct ext2_fs`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L215)` *fs`,[`struct ext2_full_inode`](https://github.com/bluegummi/charmos/blob/main/include/fs/ext2.h#L201)` *dir_inode`,`char *fname`,`uint8_t *type_out)`

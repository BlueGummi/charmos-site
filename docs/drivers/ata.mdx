...
| [`struct thread`](https://github.com/bluegummi/charmos/blob/main/include/Scheduler/thread.h#L188) | [`*waiter`](https://github.com/bluegummi/charmos/blob/main/include/drivers/ata.h#L78) |
...
- [`struct generic_disk *`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L68)[`ide_create_generic`](https://github.com/bluegummi/charmos/blob/main/include/drivers/ata.h#L126)`(`[`struct ata_drive`](https://github.com/bluegummi/charmos/blob/main/include/drivers/ata.h#L92)` *ide)`
- [`struct generic_disk *`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L68)[`atapi_create_generic`](https://github.com/bluegummi/charmos/blob/main/include/drivers/ata.h#L201)`(`[`struct ata_drive`](https://github.com/bluegummi/charmos/blob/main/include/drivers/ata.h#L92)` *d)`

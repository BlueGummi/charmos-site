...
- `void * `[`xhci_map_mmio`](https://github.com/bluegummi/charmos/blob/main/include/drivers/xhci.h#L542)`(uint8_t bus`,`uint8_t slot`,`uint8_t func)`
- [`struct xhci_device *`](https://github.com/bluegummi/charmos/blob/main/include/drivers/xhci.h#L513)[`xhci_device_create`](https://github.com/bluegummi/charmos/blob/main/include/drivers/xhci.h#L543)`(void *mmio)`

...
- [`struct bio_scheduler *`](https://github.com/bluegummi/charmos/blob/main/include/block/sched.h#L131)[`bio_sched_create`](https://github.com/bluegummi/charmos/blob/main/include/block/sched.h#L203)`(`[`struct generic_disk`](https://github.com/bluegummi/charmos/blob/main/include/block/generic.h#L68)` *disk`,[`struct bio_scheduler_ops`](https://github.com/bluegummi/charmos/blob/main/include/block/sched.h#L139)` *ops)`

...
- [`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`condvar_signal`](https://github.com/bluegummi/charmos/blob/main/include/sync/condvar.h#L20)`(`[`struct condvar`](https://github.com/bluegummi/charmos/blob/main/include/sync/condvar.h#L11)` *cv)`
- [`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`condvar_signal_callback`](https://github.com/bluegummi/charmos/blob/main/include/sync/condvar.h#L21)`(`[`struct condvar`](https://github.com/bluegummi/charmos/blob/main/include/sync/condvar.h#L11)` *cv`,`thread_action_callback cb)`

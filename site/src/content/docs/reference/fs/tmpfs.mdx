...
- [`struct vfs_node *`](https://github.com/bluegummi/charmos/blob/main/include/fs/vfs.h#L198)[`tmpfs_mkroot`](https://github.com/bluegummi/charmos/blob/main/include/fs/tmpfs.h#L44)`(char *mount_point)`

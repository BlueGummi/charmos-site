...
- [`struct cpu_mask *`](https://github.com/bluegummi/charmos/blob/main/include/smp/topology.h#L21)[`domain_create_cpu_mask`](https://github.com/bluegummi/charmos/blob/main/include/smp/domain.h#L25)`(`[`struct domain`](https://github.com/bluegummi/charmos/blob/main/include/smp/domain.h#L9)` *domain)`

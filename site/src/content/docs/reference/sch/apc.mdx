...
- `static inline const char * `[`apc_event_str`](https://github.com/bluegummi/charmos/blob/main/include/sch/apc.h#L23)`(`[`enum apc_event`](https://github.com/bluegummi/charmos/blob/main/include/sch/apc.h#L16)` evt)`
- [`struct apc *`](https://github.com/bluegummi/charmos/blob/main/include/sch/apc.h#L35)[`apc_create`](https://github.com/bluegummi/charmos/blob/main/include/sch/apc.h#L45)`(void)`
- `static inline bool `[`safe_to_exec_apcs`](https://github.com/bluegummi/charmos/blob/main/include/sch/apc.h#L65)`(void)`

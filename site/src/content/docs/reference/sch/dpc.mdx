...
- [`struct dpc *`](https://github.com/bluegummi/charmos/blob/main/include/sch/dpc.h#L9)[`dpc_create`](https://github.com/bluegummi/charmos/blob/main/include/sch/dpc.h#L23)`(dpc_func_t fn`,`void *ctx)`

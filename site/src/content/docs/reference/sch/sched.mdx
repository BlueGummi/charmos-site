...
- [`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`scheduler_try_do_steal`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L107)`(`[`struct scheduler`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L31)` *sched)`
- [`struct scheduler *`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L31)[`scheduler_pick_victim`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L109)`(`[`struct scheduler`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L31)` *self)`
- [`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`scheduler_steal_work`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L110)`(`[`struct scheduler`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L31)` *victim)`
- `static inline`[`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`scheduler_get_current_thread`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L129)`()`
- `static inline`[`enum thread_flags`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L68)[`scheduler_pin_current_thread`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L137)`()`
- `static inline void `[`scheduler_unpin_current_thread`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L146)`(`[`enum thread_flags`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L68)` flags)`
- `static inline`[`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`thread_spawn`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L155)`(char *name`,`void (*entry)(void))`
- `static inline`[`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`thread_spawn_custom_stack`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L166)`(char *name`,`void (*entry)(void)`,`size_t stack_size)`
- `static inline`[`struct thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)[`thread_spawn_on_core`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L178)`(char *name`,`void (*entry)(void)`,`uint64_t core_id)`
- `static inline void `[`scheduler_wake_from_io_block`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L185)`(`[`struct thread`](https://github.com/bluegummi/charmos/blob/main/include/sch/thread.h#L188)` *t)`
- `static inline bool `[`scheduler_self_in_resched`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L189)`()`
- `static inline bool `[`scheduler_mark_self_in_resched`](https://github.com/bluegummi/charmos/blob/main/include/sch/sched.h#L193)`(bool new)`

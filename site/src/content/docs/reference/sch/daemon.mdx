...
- `static inline const char * `[`daemon_state_str`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L77)`(`[`enum daemon_state`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L71)` s)`
- [`struct daemon *`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L86)[`daemon_create`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L108)`(`[`struct daemon_attributes`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L57)` *attrs`,[`struct daemon_work`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L39)` *timesharing_work`,[`struct daemon_work`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L39)` *background_work`,[`struct workqueue_attributes`](https://github.com/bluegummi/charmos/blob/main/include/sch/defer.h#L174)` *wq_attrs`,`char *fmt)`
- [`struct daemon_thread *`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L20)[`daemon_spawn_worker`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L116)`(`[`struct daemon`](https://github.com/bluegummi/charmos/blob/main/include/sch/daemon.h#L86)` *daemon)`
